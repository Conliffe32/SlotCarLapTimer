...
# Modification : 26 May 2026; Testing to match proto board version of code
#
# Issues to debug:
...
#   2) Code crashes after a reset is used if the next lap is too long.  The same happens after a
...
def logFinalDataToCSV():
    with open('raceData.csv', mode='a') as race_data:
        ...
        data_writer.writerow(['The race winner is: ', "TBD until I add more code"])  # TBD figure out who won
